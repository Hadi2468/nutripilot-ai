...
def display_feature_header(icon, title, description):
    """
    Display a consistent header for each NutriPilot feature.
    """
...
st.markdown(
    """
    ### Your AI Nutrition Copilot
    Personalized meal planning, healthier food choices, and
    nutrition analysis powered by Generative AI.
    """
)

st.caption(
    "Built with FastAPI • AWS Lambda • API Gateway • Groq • Streamlit"
)
...
st.sidebar.caption(
    "AI-powered nutrition planning and analysis"
)
...
st.sidebar.caption(
    "FastAPI • AWS Lambda • API Gateway • Groq"
)
...
if feature == "Weekly Diet Plan":
    ...
    display_feature_header(
        icon="🍽️",
        title="Weekly Diet Plan",
        description=(
            "Create a personalized seven-day nutrition plan "
            "based on your goals, preferences, and lifestyle."
        ),
    )
...
# ============================================================
    ...
    display_feature_header(
        ...
        description=(
            "Discover healthier alternatives for your favorite "
            "foods while keeping nutrition and taste in mind."
        ),
    )
...
# ============================================================
    ...
    display_feature_header(
        ...
        description=(
            "Analyze foods with AI-generated nutritional insights "
...
# ============================================================
    ...
    display_feature_header(
        ...
        description=(
            "Get practical AI-powered recommendations for "
...
# ============================================================
    ...
    display_feature_header(
        ...
        description=(
            "Refine an existing nutrition plan based on "
            "new preferences or dietary requirements."
        ),
    )
